...
| `exercise_completed`      | Format: `timeSpent: number`,  `repeats: number`, `calories: number`,  `exercise: string`, `exercise_completed: string`  `mistakes: [string: number]`  |  Logs everytime a user finishes an exercise |
...
| `workout_completed`    | Format:  `workout_title: string`, `date: dd mm yyyy hours:minutes:seconds`  |  Logs when a user finishes the workout and exits the workout overview |
